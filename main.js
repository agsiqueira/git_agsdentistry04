const App = {
    ...
    config: {
        AWS_videoURL_Base: "https://agsdentistry04.s3.us-east-1.amazonaws.com/assets/videos/interaction/",
...
async playVideoNow(videoUrl) {
    ...
    async sendMessage() {
        ...
        try {
            const response = await fetch(this.config.ENDPOINT_URL + "agsvh/case4/chat_exact", {
                method: "POST",
